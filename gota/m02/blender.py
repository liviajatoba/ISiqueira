...
for num in range(101):
    ...
    # Open the file
    # Your file locations
    file = '/home/liviajatoba/OpenFOAM/ISiqueira/gota/m02/blendMe/x3d/blenderX3D_%d.x3d' % num
    print('Render %s' % file)
...
#    node_glossy.inputs['Roughness'].default_value=0.34
    ...
    bpy.data.scenes['Scene'].render.filepath = '/home/liviajatoba/OpenFOAM/ISiqueira/gota/m02/blendMe/animacao/blended-%d.png' % num
